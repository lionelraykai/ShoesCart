      ...
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        <View style={styles.content}>
          ...
          <Text variant="bodyMedium" style={{ color: theme.colors.onSurfaceVariant }}>
            New accounts shop as a User. Use the demo admin account on the login screen to try
            catalog management.
          </Text>
          ...
          <Button mode="contained" onPress={handleSignUp} loading={submitting} style={styles.button}>
            Sign Up
          </Button>
